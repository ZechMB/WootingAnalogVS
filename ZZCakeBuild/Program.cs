...
namespace CakeBuild
{
    ...
    {
        public const string ProjectName = "WootingAnalogVS";
    ...
    public sealed class PackageTask : FrostingTask<BuildContext>
    {
        public override void Run(BuildContext context)
        {
            ...
            if (context.DirectoryExists($"../{BuildContext.ProjectName}/bin/{context.BuildConfiguration}/Mods/mod/publish/native"))
            {
